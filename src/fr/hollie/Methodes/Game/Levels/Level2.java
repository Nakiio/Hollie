...
public class Level2 extends JPanel implements ActionListener, KeyListener, MouseListener {
    Box block1, block2, block3, block4, block5, block6;
    Player player;
    ...
    JFrame f = new JFrame();
    public Level2(int LocX, int LocY, int SizeX, int SizeY) {
        ...
        block5 = new Box(225, 350, 1048, 300, Color.DARK_GRAY, "block5");
    ...
    public void paint(Graphics g) {
        ...
        if(Collision.GameWin == true){
            player = new Player(100000, 100000, 50, 50, false);
            player.draw(g);
    ...
    public void mouseClicked(MouseEvent e) {
        if(LevelGui.contains(e.getPoint())){
            ...
            Level2 level2 = new Level2(f.getX(), f.getY(), (int) f.getSize().getWidth(), (int) f.getSize().getHeight());
            repaint();
            f.dispose();
