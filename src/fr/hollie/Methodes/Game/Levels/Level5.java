...
public class Level5 extends JPanel implements ActionListener, KeyListener, MouseListener {
    Box block1, block2, block3, block4, block5, block6, block7, block8, block9, block10, block11, block12;
    Player player;
    ...
    JFrame f = new JFrame();
    public Level5(int LocX, int LocY, int SizeX, int SizeY) {
        this.repaint();
        ...
        block8 = new Box(450, 200, 50, 640, Color.DARK_GRAY, "block8");
        block9 = new Box(0, 0, 1048, 135, Color.DARK_GRAY, "block9");
        block10 = new Box(575, 0, 50, 400, Color.DARK_GRAY, "block10");
        block11 = new Box(700, 200, 75, 400, Color.DARK_GRAY, "block11");
        block12 = new Box(840, 0, 50, 425, Color.DARK_GRAY, "block12");
    ...
    public void paint(Graphics g) {
        ...
        block9.draw(g);block10.draw(g);
        block11.draw(g);block12.draw(g);
        LevelGui.draw(g);
        Restart.draw(g);
        ...
        if (Collision.GameOver == true) {
            ...
            g.drawString("You have finish this game!", 340, 250);
            Main.LevelPLayer = 5;
        }
    ...
    public void mouseClicked(MouseEvent e) {
        if(LevelGui.contains(e.getPoint())){
            ...
            Level5 level2 = new Level5(f.getX(), f.getY(), (int) f.getSize().getWidth(), (int) f.getSize().getHeight());
            repaint();
            f.dispose();
