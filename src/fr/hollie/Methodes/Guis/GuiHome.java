...
public class GuiHome {
    ...
    public static void GuiHome(){
        ...
        Button.Button(panel,300,300,430,60,null,
                null, "Play", true, "assets/images/ButtonPlayTexture.png", 30);
        Button.Button(panel,300,370,210,60,null,
                null, "Settings", true, "assets/images/Button.png", 30);
        Button.Button(panel,520,370,210,60,null,
                null, "Leave", true, "assets/images/Button.png", 30);
